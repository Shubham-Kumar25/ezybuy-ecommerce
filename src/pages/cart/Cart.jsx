...
function Cart() {
  ...
  const buyNow = async () => {
    ...
    var options = {
      key: "rzp_test_3KT5mm4ca6CFNu",
      key_secret: "MXjtRxVSiqAQDfjdcnBP0xTw",
                ...
                >
                  ...
                  <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                    ...
                    <div
                      ...
                      className="flex justify-between mt-4 cursor-pointer sm:space-y-6 sm:mt-0 sm:block sm:space-x-6"
                    >
                      <svg
